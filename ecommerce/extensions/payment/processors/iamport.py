...
class Iamport(BasePaymentProcessor):
    ...
    def __init__(self):
        print self
        # iamport_pay(imp_key='8764255944804073', imp_secret='azDmP3cHOT76tE4U6SWwYGUL639Ax7nHH14w4geT9mZD04x7XtEVazHhCQR9XeREgVbkcqemMeZNixUg')
        # iamport = Iamport(imp_key='8764255944804073', imp_secret='azDmP3cHOT76tE4U6SWwYGUL639Ax7nHH14w4geT9mZD04x7XtEVazHhCQR9XeREgVbkcqemMeZNixUg')
        # super(iamport_pay, self).__init__(imp_key='8764255944804073', imp_secret='azDmP3cHOT76tE4U6SWwYGUL639Ax7nHH14w4geT9mZD04x7XtEVazHhCQR9XeREgVbkcqemMeZNixUg')
    ...
    def handle_processor_response(self, response, basket=None):
        print 'handle_processor_response start ~~~~~~~~~~~~~'

        iamport = self.iamport_api
        print 'handle_processor_response ---->>>> ', response
    ...
    def issue_credit(self, source, amount, currency):
        ...
        try:
            ...
            # refund_data = iamport.cancel(u'환불 승인', imp_uid='1232132112', amount=amount)
